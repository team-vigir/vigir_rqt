...
class FootstepParamControlDialog(QWidget):

    def __init__(self):
        super(FootstepParamControlDialog, self).__init__(None)

        self._widget = FootstepParamControlWidget(self)
        ...
        # #define WINDOW_FOOTSTEP_PARAMETER  3
        self._window = 3
        ...
        settings = QSettings("OCS", "footstep_param_control")
